...
async def confirm_answer(message: Message, state: FSMContext):
    ...
    crud_commands.add(model=models.Taxi, data=data)
...
async def info_answer(message: Message, state: FSMContext):
    ...
    await message.answer(summary, parse_mode="HTML", reply_markup=edit_profile)


async def update_info_answer(message: Message, state: FSMContext):
    await info_answer(message, state)
...
async def get_new_firstname_answer(message: Message, state: FSMContext):
    crud_commands.update(models.Taxi, {'telegram_id': message.from_user.id}, {'firstname': message.text})
...
async def get_new_lastname_answer(message: Message, state: FSMContext):
    crud_commands.update(models.Taxi, {'telegram_id': message.from_user.id}, {'lastname': message.text})
...
async def get_new_phone_answer(message: Message, state: FSMContext):
    ...
    crud_commands.update(models.Taxi, {'telegram_id': message.from_user.id}, {'phone_number': phone})
...
async def get_new_car_model_answer(message: Message, state: FSMContext):
    crud_commands.update(models.Taxi, {'telegram_id': message.from_user.id}, {'car_model': message.text})
...
async def get_new_car_number_answer(message: Message, state: FSMContext):
    crud_commands.update(models.Taxi, {'telegram_id': message.from_user.id}, {'car_number': message.text})

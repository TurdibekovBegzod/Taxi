...
# Allow the DB URL to come from the application settings (models.DATABASE_URL)
config.set_main_option('sqlalchemy.url', getattr(models, 'DATABASE_URL', config.get_main_option('sqlalchemy.url')))
